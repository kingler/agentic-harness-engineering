...
description: Walk the user through drafting AGENTS.md / CLAUDE.md for the app they're reverse-engineering. Five-section anatomy, one section at a time. Use when the user starts the Component 1 breakout.
---
...
If the user named one in this turn already, skip the question and acknowledge.
