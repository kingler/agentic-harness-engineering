---
name: draft-rules-hooks
description: Walk the user through pairing settings.json rules with a pre-tool-use hook for the app they're reverse-engineering. Use when the user starts the Component 4 breakout.
---
