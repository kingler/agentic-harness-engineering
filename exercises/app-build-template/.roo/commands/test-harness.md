...
> **RooCode command.** Type `/test-harness` in the RooCode chat after
> `/bootstrap-harness`, once you've filled in real content. Copy-paste probes
> for hands-on testing live in `TESTING.md`.
