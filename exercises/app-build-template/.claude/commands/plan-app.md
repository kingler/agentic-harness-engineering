---
name: plan-app
description: STEP 1 of the build. Turn the app brief (core features, value proposition, the problem it solves) into a detailed build plan, wireframes, and a technology + harness spec. Plan before you build. Chains to /bootstrap-harness.
...
**Nothing gets scaffolded or coded until this plan exists.** Your job is to
turn a one-page app brief into three artifacts the build will run on:
...
Read `app-brief.md` at the project root. If it is missing or still full of
