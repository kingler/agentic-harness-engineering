---
name: draft-tool
description: Walk the user through writing a tool descriptor (WHAT / WHEN / WHEN-NOT) plus its executable body. Use when the user starts the Component 3 breakout.
---
