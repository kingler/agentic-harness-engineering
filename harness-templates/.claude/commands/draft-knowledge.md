...
description: Walk the user through writing a knowledge file plus a session memory scaffold. Slow tier vs fast tier — what stays where. Use when the user starts the Component 5 breakout.
---
